...
(function (window, document, $) {
  ...
  $(document).on('click', '.mintifi-repeater', function (e) {
    // Hide menu
    $(this).closest(".repeater-main-container").find('.repeater-container .repeater-container-item:first-child').clone().appendTo($(this).closest(".repeater-main-container").find('.repeater-container'))
    return false;
  });
  ...
  $('.search-input-close').on('click', function () {
    ...
    if (searchInput.hasClass('open')) {
      searchInput.removeClass('open');
      searchInputInputfield.val('Search');
      searchInputInputfield.blur();
      searchList.removeClass('show');
